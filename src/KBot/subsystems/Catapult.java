...
public class Catapult extends Subsystem 
{
    ...
    public void shootRoutineByTiming()
    {
        ...
        else if(timer.get() < initialPositionTime + springBackTime)
        {
            shoot(-1.0);
            disengageBrake();
            shootingState = 1;
        ...
        else if(timer.get() < initialPositionTime + springBackTime + shootTime + zeroingTime + stabalizingTime)
        {
            ...
            shootingState = 4;
                ...
                stabalizingTime + loadToBottom && !isLimitPressed())
        {
            shoot(-0.5);
            shootingState = 5;
        }
    ...
    public void shootRoutineByPotentiometer()
    {
        ...
        if(shootingState == 1 && calibratedValue > 0 && !isLimitPressed() && 
        ...
        if(shootingState == -2 && calibratedValue < 0.2 && 
                timer.get() - timeSinceLastState < 0.5)
        { 
        ...
        if(shootingState == 3 && calibratedValue > 0.93 && 
                timer.get() - timeSinceLastState < 0.5)
        {
            shoot(-0.6);
            engageBrake();
